  ...
  if(options.fcm && options.fcm.serviceAccountJson){
      ...
      self.sendFCM = function(userToken, notification) {
          ...
          if (typeof message.android.notification === 'undefined'){
            ...
            if (typeof notification.androidChannel !== 'undefined' && typeof message.android.data['channel_id'] === 'undefined') message.android.data['channel_id'] = notification.androidChannel.toString();
          }
          // ***
          /* End Android */
