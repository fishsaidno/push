...
/* global Push: true, initPushUpdates: false */

import { EJSON } from 'meteor/ejson';
import { Meteor } from 'meteor/meteor';
import { EventState } from '../common/event-state.js';

// Platform fallback for plugin versions that do not report registrationType.
    ...
    if (!this.configured) {
      ...
      Meteor.startup(() => {
        ...
        if (typeof PushNotification !== 'undefined') {
          ...
          // cordovaOptions object used to init cordova-plugin-push
          ...
          this.push.on('registration', (data) => {
            ...
            if (data && data.registrationId && this.token !== data.registrationId) {
              ...
              if (data.registrationType && data.registrationType.toLowerCase() === 'fcm') {
                ...
                // Otherwise use APN for iOS and FCM for Android.
