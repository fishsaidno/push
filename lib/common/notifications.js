...
var _validateDocument = function(notification) {
  ...
  check(notification, {
    ...
    androidChannel: Match.Optional(String),      // TODO: used for FCM - propose to unify with below
    android_channel_id: Match.Optional(String),  // TODO: used for GCM - propose to unify with above
    apn: Match.Optional({
