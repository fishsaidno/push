...
/* global Push: false, _legalPayload: true, _matchToken: true */
...
_matchToken = Match.OneOf({ apn: String }, { fcm: String });
  ...
  if (typeof payload !== 'undefined'){
    ...
    var illegalKey = _.find(payload, function(value, key, list){
      ...
      if (
          ...
          key === 'gcm.message_id' || // Reserved metadata key used by Firebase-compatible clients
...
Push.send = function(options) {
  ...
  if (Meteor.isServer) {
    return Push.notifications.insertAsync(notification);
  }
